...
export function BrandStoryTeaser() {
  return (
    <section className="mx-auto w-full max-w-[1280px] px-4 py-12 md:px-8">
      <div className="grid gap-6 rounded-2xl bg-hh-muted p-6 sm:grid-cols-2 sm:p-10">
        <div>
          ...
          <Link
            ...
            className="mt-6 inline-flex h-11 items-center justify-center rounded-md bg-hh-primary px-6 text-sm font-medium text-white"
          >
            Khám phá câu chuyện
          </Link>
        </div>
        <div className="grid grid-cols-3 gap-3 self-center">
          {BRAND_STORY.milestones.map((milestone) => (
            <div key={milestone.year} className="rounded-xl bg-white p-3 text-center">
